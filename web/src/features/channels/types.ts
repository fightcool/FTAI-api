...
export interface ChannelBalanceResponse {
  ...
  currency?: string
  raw_response?: string
  usage?: ChannelUsageQueryResult
}

// Upstream usage/balance facts extracted by a usage query template, in the
// upstream's own currency; balance is separately stored as USD.
export interface ChannelUsageQueryResult {
  balance: number
  remaining: number
  used: number
  currency: string
