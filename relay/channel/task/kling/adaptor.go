...
func (a *TaskAdaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (taskID string, taskData []byte, taskErr *dto.TaskError) {
	...
	// 提取 task_id：优先从 Data.TaskId 获取，回退到顶层 TaskId
	...
	// identify-face 是同步接口，需要透传人脸数据到 metadata
	if info.Action == constant.TaskActionIdentifyFace {
...
func (a *TaskAdaptor) GetModelList() []string {
	return []string{"kling-v1", "kling-v1-6", "kling-v2-master", "kling-advanced-lip-sync"}
}
